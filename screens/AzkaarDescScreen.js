...
import { ActivityIndicator, Image, Modal, StyleSheet, 
  Text, TouchableOpacity, TouchableWithoutFeedback, 
  View, Button, ImageBackground, ScrollView } from 'react-native';
...
export default class AzkaarDescScreen extends Component {
  ...
  componentDidMount = () => {
    ...
    AsyncStorage.getItem(AZKAAR_AZKAAR)
      .then((data) => JSON.parse(data))
      .then((data) => {
        let duaData = data.azkaar.azkaar[this.state.topic.id]
        this.setState({
          duaData: duaData,
        })
      })
